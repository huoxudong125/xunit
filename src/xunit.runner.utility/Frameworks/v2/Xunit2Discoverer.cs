...
namespace Xunit
{
    ...
    public class Xunit2Discoverer : ITestFrameworkDiscoverer
    {
                         ...
                         IMessageSink diagnosticMessageSink)
        {
            ...
            appDomain = useAppDomain ? (IAppDomainManager)new RemoteAppDomainManager(appDomainAssembly, configFileName, shadowCopy, shadowCopyFolder) : new NoAppDomainManager(appDomainAssembly);
