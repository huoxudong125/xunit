...
namespace Xunit
{
    ...
    public class Xunit1Executor : IXunit1Executor
    {
        ...
        {
            appDomain = useAppDomain ? (IAppDomainManager)new RemoteAppDomainManager(testAssemblyFileName, configFileName, shadowCopy, shadowCopyFolder) : new NoAppDomainManager(testAssemblyFileName);
